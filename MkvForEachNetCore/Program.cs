...
namespace MkvForEachNetCore
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var s =@"C:/Users/steff/Downloads/mkvtoolnix-64bit-10.0.0\mkvmerge.exe --ui-language de --output 'D:\VID_20170403_085827.mkv' --language 0:und --compression 0:zlib --language 1:und 'D:\Temp\TestVideos\1.mp4' --track-order 0:0,0:1";
            var strCmdText = $@"/C {s}";
